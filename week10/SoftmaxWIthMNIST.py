...
y_val_oh = one_hot_encode(y_val, num_classes=10)
...
x_val_img = x_val[0].reshape(28, 28)    # First image in testing set
...
plt.imshow(x_val_img, cmap='gray')
...
def train_mnist(
    ...
    for epoch in range(num_epochs):
        ...
        _, _, _, test_probs = forward_pass(x_val, W1, b1, W2, b2)
        test_loss = cross_entropy_loss(test_probs, y_val)
        test_acc  = accuracy(test_probs, y_val)
...
if __name__ == "__main__":
    ...
    # Using the first image from x_val
    first_test_image = x_val[20]  # This is already a numpy array flattened to shape (784,)
    ...
    # ================== SHOW ===================
    import matplotlib.pyplot as plt
    x_val_img = first_test_image.reshape(28, 28)    # First image in testing set
