...
# ====== SETTINGS ======
SRC = Path(r"/Users/kaungkhantlin/Developer/2_2025/AI_Concepts/project/img/YOLODataset")                 # your original dataset folder
...
transform = A.Compose(
    [
        ...
        A.ShiftScaleRotate(shift_limit=0.05, scale_limit=0.20, rotate_limit=10, p=0.5),
